...
void App::addScreens() {
	...
	m_optionsMenuScreen = std::make_unique<OptionsMenuScreen>(&m_window, m_options);       /// 2
	...
	m_gameplayScreen = std::make_unique<GameplayScreen>(&m_window, m_WorldIOManager, world, m_options);             /// 5
