...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)boost_thread $(LibrarySwitch)boost_filesystem $(LibrarySwitch)boost_system $(LibrarySwitch)lua5.3 $(LibrarySwitch)GLEngine $(LibrarySwitch)CEGUIBase-0 $(LibrarySwitch)CEGUIOpenGLRenderer-0 $(LibrarySwitch)SDL2 $(LibrarySwitch)SDL2_mixer $(LibrarySwitch)SDL2_ttf $(LibrarySwitch)GL $(LibrarySwitch)GLU $(LibrarySwitch)GLEW $(LibrarySwitch)pthread 
ArLibs                 :=  "libboost_thread.a" "libboost_filesystem.a" "libboost_system.a" "lua5.3" "libGLEngine.a" "CEGUIBase-0" "CEGUIOpenGLRenderer-0" "SDL2" "SDL2_mixer" "SDL2_ttf" "GL" "GLU" "GLEW" "pthread" 
...
$(IntermediateDirectory)/DialogueManager.cpp$(ObjectSuffix): DialogueManager.cpp $(IntermediateDirectory)/DialogueManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/davis-dev/Documents/Programming/C++/CodingGithub/Fear-Of-The-Dark/Code/DialogueManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DialogueManager.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/DialogueManager.cpp$(DependSuffix): DialogueManager.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/DialogueManager.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/DialogueManager.cpp$(DependSuffix) -MM DialogueManager.cpp

$(IntermediateDirectory)/DialogueManager.cpp$(PreprocessSuffix): DialogueManager.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/DialogueManager.cpp$(PreprocessSuffix) DialogueManager.cpp
