...
namespace ScriptingModule {
	...
	class ParticleUpdate {
	  ...
	  private:
		static void updateFunction(GLEngine::Particle2D& particle,
								   float				 deltaTime,
	...
	class LuaScript {
	  public:
		...
		void setThread(lua_State* s) {
			T = s;
		}

		unsigned int getThreadReference() {
			return m_threadReference;
		}
		...
		bool isAddedToYieldList() {
			return m_addedToYieldList;
		}

		void setAddedToYieldList() {
			m_addedToYieldList = true;
		}
