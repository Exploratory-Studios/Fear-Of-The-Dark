...
void addBackgroundImage(std::vector<GLEngine::GLTexture>& backgroundImages, std::string filename) {
	backgroundImages.emplace_back(
		GLEngine::ResourceManager::getTexture(ASSETS_FOLDER_PATH + "Textures/MainMenuBackgrounds/" + filename));
}
...
void MainMenuScreen::initUI() {
	...
	{
		m_titleLine1 = static_cast<CEGUI::DefaultWindow*>(m_gui.createWidget("FOTDSkin/Label",
		...
		m_titleLine2 = static_cast<CEGUI::DefaultWindow*>(m_gui.createWidget("FOTDSkin/Label",
...

	{
		...
		m_playButton = static_cast<CEGUI::PushButton*>(m_gui.createWidget("FOTDSkin/Button",
